...
const AdminLogin = () => {
    ...
    return (
        <div
            style={{
                backgroundImage: `url('https://www.stroke.org/en/-/media/Stroke-Images/Healthy-Living/fruits-and-vegetables.jpg?h=450&iar=0&mw=1910&w=800&sc_lang=en')`,
        ...
        >
            ...
            >
                <Card className="shadow p-4" style={{ width: '400px', backdropFilter: 'blur(10px)', backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
                    <Card.Body>
